...
export const dict = {
  ...
  "ssh.authenticate": "SSH 认证",
  "ssh.action.authenticate": "认证",
  ...
  "ssh.authenticationRequired": "{{host}} 需要认证",
  "ssh.trust": "信任并连接",
  "ssh.continue": "继续",
  "ssh.retry": "重试",
  "ssh.update": "更新并重新连接",
  ...
  "ssh.stage.ready": "已连接",
  "ssh.stage.authentication": "需要认证",
  "ssh.stage.incompatible": "需要更新服务器",
  "ssh.stage.failed": "连接失败",
  "ssh.error.input": "请输入主机或 SSH 连接命令。不允许使用远程命令和不受支持的 SSH 选项。",
  "ssh.error.connection": "无法建立 SSH 连接。请检查网络和 SSH 配置。",
  "ssh.error.platform": "不支持此远程平台。自动安装目前要求 x64 或 arm64 上的 Linux 或 macOS。",
  "ssh.error.version": "远程服务必须与此桌面版版本一致才能连接。",
  "ssh.error.install": "无法安装远程服务器。请检查网络连通性、磁盘空间，并确认已安装 tar。",
  "ssh.error.unpublished": "此桌面版没有已发布的远程服务器。对于开发版，请在主机上安装并启动 V2 后重试。",
  "ssh.error.service": "SSH 已连接，但 OpenCode 服务器未能就绪。",
  "ssh.error.host-key": "无法验证主机身份。请先确认其指纹，再更新 SSH known_hosts。",
  "ssh.error.ssh-missing": "未找到 OpenSSH。请安装 OpenSSH 客户端并确保 ssh 在 PATH 中可用。",
  ...
  "server.connect.description": "输入服务器地址和密码即可开始。",
  "server.connect.button": "连接",
  "server.connect.address.invalid": "请输入有效的 HTTP 或 HTTPS 服务器地址。",
  "server.connect.failed": "无法连接。请检查服务器地址和密码后重试。",
  "server.connect.pair.description": "在你的电脑上运行此命令以获取连接信息。",
  "server.connect.scan": "扫描二维码",
  "server.connect.scan.description": "用相机对准 opencode pair 显示的二维码。",
  "server.connect.scan.invalid": "这不是 OpenCode 配对码。请扫描 opencode pair 显示的二维码。",
  "server.connect.camera": "配对相机",
  "server.connect.camera.starting": "正在打开相机…",
  "server.connect.mixedContent": "无法从 HTTPS 页面连接到该 HTTP 服务器。请改用 HTTPS 服务器地址。",
  "server.connect.camera.insecure": "扫描二维码需要通过 HTTPS 或在本机（localhost）打开此页面。",
  "server.connect.camera.unavailable": "此浏览器没有可用相机。请手动输入连接信息。",
  "server.connect.camera.error": "无法打开相机。请允许相机访问权限，或手动输入连接信息。",
  "dialog.server.menu.remove": "移除",
  "dialog.server.menu.hide": "从项目列表中隐藏",
  "dialog.server.menu.show": "在项目列表中显示",
  "server.row.incompatible": "此服务器运行的 OpenCode {{version}} 与此应用不兼容。请升级到 OpenCode V2 以继续。",
  "file.error.notFound": "未找到文件：{{name}}",
  "file.view.preview": "预览",
  "file.view.source": "源码",
  "file.view.openInBrowser": "在浏览器中打开",
  "file.view.binary": "二进制文件 · {{size}}",
  "file.view.table.rows.one": "{{count}} 行",
  "file.view.table.rows.other": "{{count}} 行",
  "file.view.table.columns.one": "{{count}} 列",
  "file.view.table.columns.other": "{{count}} 列",
  "file.view.table.truncated": "仅显示前 {{shown}} 行，共 {{total}} 行。",
  "file.view.fontSample": "敏捷的棕色狐狸跃过懒狗",
  ...
  "home.workspaceTip": "在新工作区中开始下一个会话，以保持更改相互隔离",
  ...
  "session.error.incompatible.description":
    "{{server}} 运行的 OpenCode {{version}} 与此应用不兼容。请将服务器升级到 OpenCode V2 以继续。",
  "session.background.moveTasks": "将{{tasks}}移到后台",
  "session.background.moveRunning": "移到后台",
  "session.background.inBackground": "正在后台运行{{tasks}}",
  "session.background.moveInline": "按 {{keybind}} 将正在运行的任务移到后台",
  "session.background.running": "正在后台运行任务",
  ...
  "session.queue.count.one": "{{count}} 条已排队",
  "session.queue.count.other": "{{count}} 条已排队",
  "session.queue.steer": "引导",
  "session.queue.send": "发送",
  "session.queue.steerTooltip": "发送但不中断当前回合",
  ...
  "session.websearch.title": "第三方网络搜索",
  "session.websearch.description": "选择智能体用于网络搜索的搜索提供商",
  ...
  "session.new.worktree.creating": "正在创建工作区",
  "session.new.worktree.draftPlaceholder": "工作区准备期间可先起草后续消息…",
  ...
  "session.browser.suspended": "浏览器已挂起。与此会话交互以重新连接。",
  "session.browser.address.placeholder": "输入 URL",
  "session.browser.empty.title": "输入 URL",
  "session.browser.empty.description": "或输入“在应用浏览器中打开”",
  "session.browser.failed.title": "无法访问该 URL",
  "session.browser.failed.description": "请检查网址和网络连接后重试。",
  "titlebar.tabs": "标签页",
  ...
  "debugBar.ttft.tip": "从发起提供商请求到模型首次输出所需的时间。",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "从发起提供商请求到首个回答文本出现所需的时间。",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "模型首次输出后每秒生成的词元数。",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "从发起提供商请求到其响应流结束所需的时间。",
  ...
  "settings.search.empty": "没有找到“{{query}}”的结果",
  ...
  "settings.about.otherContributor.one": "另外 {{count}} 人",
  "settings.about.otherContributor.other": "另外 {{count}} 人",
  "settings.about.firstPublished": "首次发布于美国密苏里州",
  "settings.about.firstIllustrated": "首次插画于英国伦敦",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode，开源编程智能体",
  "settings.about.trademark": "OpenCode 是 Anomaly Innovations, Inc. 的注册商标。",
  "settings.about.typeset": "字体采用 Inter 与 IBM Plex Mono",
  "settings.about.tagline": "没有你，AI 无法构建优秀的软件",
  ...
  "settings.appearance.section.experimental": "实验性",
  ...
  "settings.appearance.row.projectName.description": "在垂直标签页和移动端标签页抽屉中显示项目名称",
  "settings.notifications.description": "选择何时接收通知和提示音",
  ...
  "settings.server.preferences.websearch.description": "选择智能体用于网络搜索的搜索提供商",
  ...
  "settings.extensions.availableAll": "所有项目均可用",
  ...
  "project.settings.name.description": "在 OpenCode 中显示的项目名称",
  "project.settings.icon.description": "建议：128×128 像素。点击或拖拽上传图片。",
  "project.settings.color.description": "未设置自定义图片时用于项目图标",
  "project.settings.worktree.startup.description": "创建新工作区后运行一次",
  "project.settings.worktree.startup.hint.base": "使用 $OPENCODE_WORKTREE_BASE 获取基准工作区。",
  "project.settings.worktree.startup.hint.new": "使用 $OPENCODE_WORKTREE_PATH 获取新工作区。",
  ...
  "project.settings.extensions.empty.mcps.description": "OpenCode 可用的 MCP 会显示在这里",
  "project.settings.extensions.empty.plugins.title": "暂无插件",
  "project.settings.extensions.empty.plugins.description": "OpenCode 可用的插件会显示在这里",
  "project.settings.extensions.empty.skills.title": "暂无技能",
  "project.settings.extensions.empty.skills.description": "OpenCode 可用的技能会显示在这里",
  ...
  "project.settings.extensions.lsp.status.enabled": "配置中已启用",
  "project.settings.extensions.lsp.status.disabled": "配置中已禁用",
  "project.settings.extensions.lsp.empty.title": "未配置语言服务器",
  "project.settings.extensions.lsp.empty.description": "为此项目配置的语言服务器会显示在这里",
  ...
  "settings.timeline.description.everything": "分别显示所有活动。展开 shell 输出、编辑和思考过程。",
  "settings.timeline.description.detailed": "展开 shell 输出和编辑。单独显示子代理，其他活动分组显示。",
  "settings.timeline.description.compact": "所有活动分组显示，详情默认折叠。",
  "settings.timeline.description.quiet": "编辑和子代理分组显示，隐藏其他活动。",
  ...
  "settings.timeline.advanced.description": "为每类活动设置位置和显示详情。",
  ...
  "settings.timeline.grouped.label": "{{activity}}分组",
  "settings.timeline.collapsed.label": "{{activity}}折叠",
  ...
  "settings.timeline.category.notices": "提示",
  ...
  "settings.general.row.browserPane.description": "允许智能体打开并控制应用内开发浏览器。",
  "settings.general.row.showProjectIcon.title": "显示项目图标",
  "settings.general.row.showProjectIcon.description": "在会话标题中显示项目图标",
  "settings.general.row.mobileDiffWrap.description": "移动端差异视图中自动换行，而不是水平滚动",
  "settings.general.row.followUpBehavior.title": "后续消息行为",
  "settings.general.row.followUpBehavior.description":
    "选择是将后续消息排队，还是引导当前回合。使用 {{keybind}} 切换。",
  ...
  "settings.updates.migration.title": "从 Beta 迁移到 Stable",
  "settings.updates.migration.description":
    "目前 OpenCode Beta 正在迁移到 OpenCode Stable。请下载 {{version}} 版，然后从磁盘映像安装 OpenCode 以继续接收更新。",
  "common.viewAll": "查看全部",
  "session.new.workspace.local.tooltip": "使用项目当前的检出目录",
  ...
  "session.new.workspace.search.empty": "没有匹配的工作区",
  "settings.tab.workspaces": "工作区",
  "settings.workspaces.description": "查看工作区并管理磁盘占用",
  "settings.workspaces.filter.all": "所有项目",
  "settings.workspaces.empty": "暂无工作区",
  "settings.workspaces.empty.description": "在 OpenCode 中创建工作区后会显示在这里",
  ...
  "settings.workspaces.deleteAll.confirm.one": "这将永久删除 {{count}} 个所选工作区。",
  "settings.workspaces.deleteAll.confirm.other": "这将永久删除 {{count}} 个所选工作区。",
  "settings.workspaces.deleteWithoutSessions": "删除没有会话的工作区",
  "settings.workspaces.deleteWithoutSessions.confirm.one": "这将永久删除 {{count}} 个没有关联会话的工作区。",
  "settings.workspaces.deleteWithoutSessions.confirm.other": "这将永久删除 {{count}} 个没有关联会话的工作区。",
  "settings.workspaces.deleteWithoutSessions.warning": "存在未合并更改或活跃位置的工作区将被保留。",
  "settings.workspaces.delete.button": "删除工作区",
  "settings.workspaces.delete.warning": "这将永久删除该工作区及其分支。",
  "settings.workspaces.deleteAll.warning": "存在未合并更改、关联会话或活跃位置的工作区将被保留。",
  "settings.workspaces.delete.blocked.active": "无法删除当前活跃的工作区。",
  ...
  "settings.workspaces.default.lastUsed": "按项目记录上次使用",
  ...
  "workspace.onboarding.description": "每个会话都有独立的检出目录",
  ...
  "session.summary.mcp.onCreation": "在创建工作区时应用",
  "session.summary.mcp.prepareFailed": "无法准备 MCP 服务器",
  "session.summary.mcp.unavailable": "MCP 服务器 {{name}} 在此工作区中不可用。",
  "session.summary.mcp.signInBeforeSend": "发送消息前请先登录 {{name}}。",
  "session.summary.mcp.notReady": "MCP 服务器 {{name}} 尚未就绪。请在发送消息前解决其连接问题。",
